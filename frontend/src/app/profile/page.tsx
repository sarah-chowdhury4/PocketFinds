            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-2xl font-bold">{user.upvotesReceived}</p>
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-2xl font-bold">{user.stallsVisited}</p>
                  <p className="text-sm text-muted-foreground">Stalls Visited</p>
                </CardContent>
              </Card>
            </div>
